...
public class MainActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		titlePageImage = (ImageView)findViewById(R.id.List);
		titlePageImage.setOnClickListener(this);
	}

	@Override
	public void onClick(View v) {
		// TODO Auto-generated method stub
		if (v == findViewById(R.id.List)) {
			...
			Intent intent = new Intent(this, com.artifex.mupdflib.MuPDFActivity.class);//com.artifex.mupdflib.MuPDFActivity.class
